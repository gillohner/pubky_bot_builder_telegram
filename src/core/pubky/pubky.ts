		...
		services: [
			{
				...
				command: "hello",
				kind: "single_command",
				entry: "./src/example_services/hello.ts",
				version: "1.0.0",
			},
			{
				name: "Keyboard",
				command: "keyboard",
				kind: "single_command",
				entry: "./src/example_services/keyboard.ts",
			},
			{
				name: "Photo",
				command: "photo",
				kind: "single_command",
				entry: "./src/example_services/photo.ts",
			},
			{
				name: "Flow",
				command: "flow",
				kind: "command_flow",
				entry: "./src/example_services/flow.ts",
			},
			{
				name: "Survey",
				command: "survey",
				kind: "command_flow",
				entry: "./src/example_services/survey.ts",
			},
			{
				name: "Links",
				command: "links",
				kind: "single_command",
				entry: "./src/example_services/links.ts",
			},
			{
				name: "Env Probe",
				command: "env",
				kind: "single_command",
				entry: "./src/example_services/env_probe.ts",
			},
			{
				name: "Security Probe",
				command: "secprobe",
				kind: "single_command",
				entry: "./src/example_services/security_probe.ts",
			},
		],
		listeners: [
			{
				...
				command: "listener",
				kind: "listener",
				entry: "./src/example_services/listener.ts",
			},
		],
	},
	fake: {
